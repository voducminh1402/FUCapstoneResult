            ...
            <div id="content">
                ...
                <div class="content-detail content-post add-post">
                    ...
                    <form action="MainController" method="POST">
                        <label for="">Mã Đồ Án</label><br>
                        <input type="text" name="" value="${requestScope.VIEW_PROJECT.projectID}" readonly="">
                        <label for="">Kỳ Đồ Án</label><br>
                        <input type="text" name="" value="${requestScope.VIEW_PROJECT.semesterID}" readonly="">
                        <label for="">Tên Đồ Án</label><br>
                        <input type="text" name="" value="${requestScope.VIEW_PROJECT.projectName}" readonly="">
                        <label for="">Mô Tả Đồ Án</label><br>
                        <input type="text" name="" value="${requestScope.VIEW_PROJECT.projectDescription}" readonly="">
                        <label for="">Điểm Đồ Án</label><br>
                        <input type="text" name="" value="${requestScope.VIEW_PROJECT.projectScore}" readonly="">
                        <label for="">Ảnh Bìa Đồ Án</label><br>
                        <img class="infor-image" src="${requestScope.VIEW_PROJECT.projectImage}"/>
