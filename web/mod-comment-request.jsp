                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="MainController" method="POST">
                                                        <p style="color: #3308ce ; font-size:15px">25/1/2021 lúc 13:00
                                                            pm</p>
                                                        <p style="color:black">Bài này thật tuyệt
                                                            vời.Rất cảm ơn những chia sẻ và đóng góp quý báu của
                                                            anh.
                                                        </p>
                                                            ...
                                                            <ol class="breadcrumb">
                                                                <li class="breadcrumb-item">
                                                                    ...
                                                                    <button type="submit" name="action"
                                                                        value="AddComment" value="AddComment"
                                                                        class="btn btn-primary btn-sm">Xét
                                                                        Duyệt</button>
                                                                </li>
                                                                <li class="breadcrumb-item"><a href="#"
                                                                        style="color:red">Huỷ</a>
                                                                </li>
                                                            </ol>
                                                        </nav>
                                                    </form>
                                                ...
                                                <td>
                                                    <a href="blog-single.html">Những mẹo khi làm <br />đồ án tốt
                                                        nghiệp</a>
                                                </td>
                                            </tr>
                                        </tbody>
