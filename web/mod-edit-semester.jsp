        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="content-detail content-post add-post">
                    <h2>Sửa Tên Kỳ Thực Hiện Đồ Án</h2>

                    <form action="MainController" method="POST">
                        <label for="">Mã Kỳ Đồ Án</label><br>
                        <input type="text" name="id" value="${requestScope.SEMESTER_EDIT_NAME.semesterID}" readonly>
                        <label for="">Tên Kỳ Đồ Án</label><br>
                        <input type="text" name="semester-name" value="${requestScope.SEMESTER_EDIT_NAME.semesterName}" required>

                        <div class="add-project-submit">
                            <button type="submit" name="action" value="UpdateSemesterController">Lưu</button>
