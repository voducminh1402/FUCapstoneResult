                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="manage-project">
                                    <div class="menu-search menu-search-project">
                                        <button><i class="fa fa-search" aria-hidden="true"></i></button>
                                        <input class="mod-menu-input" type="text" placeholder="Tìm Kiếm Đồ Án...">
                                    </div>
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                <c:if test="${requestScope.PROJECT_LIST == null}">
                                    <c:redirect url="MainController?action=GetListProject&page=project"></c:redirect>
                                </c:if>
                                <c:forEach items="${requestScope.PROJECT_LIST}" var="o" varStatus="counter">
                                    <tr>
                                        <td>${counter.count}</td>
                                        <td>${o.projectName}</td>
                                        <td class="last-type__menu">
                                            ...
                                            <div class="more-choice__menu">
                                                <div class="more-choice__item">
                                                    <a href="MainController?action=GetListProject&id=${o.projectID}&page=view-project">
                                                        <span>Xem Chi Tiết</span>
                                                        <i class="fa fa-eye" aria-hidden="true"></i>
                                                    </a>
                                                </div>
                                                <div class="more-choice__item">
                                                    <a href="MainController?action=GetListProject&id=${o.projectID}&page=update-project">
                                                        <span>Chỉnh Sửa</span>
