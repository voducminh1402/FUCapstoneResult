            ...
            <section>
                <div class="row">
                    <div class="col-md-2 list-instructor">
                        ...
                        <div>
                            <ul>
                                <li><button>Tran Quang Quyen</button></li>
                                <li><button>Tran Quang Quyen</button></li>
                                <li><button>Tran Quang Quyen</button></li>
                                <li><button>Tran Quang Quyen</button></li>
                                <li><button>Tran Quang Quyen</button></li>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <img class="instructor-img"
                                    src="https://scontent.fdad1-2.fna.fbcdn.net/v/t1.6435-9/101895704_2699776656971658_7283572034964029440_n.jpg?_nc_cat=105&ccb=1-5&_nc_sid=cdbe9c&_nc_ohc=fg9gTNrUMIkAX9jZxEQ&_nc_ht=scontent.fdad1-2.fna&oh=00_AT8-MUxk1FLbH6eSvyJGnp8N4U-BG-TBdmJRqGaBTUnhIQ&oe=62275746"
                                    alt="">
                                <h1>ThS. Nguyễn Thế Hoàng</h1>
                            </div>
                            <div class="col-md-7 description-content">
                                ...
                                <p class="notice">"HAPPY CODE, HAPPY MONEY, HAPPY LIFE"</p>
                            </div>
                        </div>
                        <br>
                        <br>
                                ...
                                <div class="container">
                                    <div class="capstone-slider">
                                        <div class="good-capstone-slide">
                                            <% ProjectDAO dao=new ProjectDAO(); ProjectInstructorDAO proinsDao=new
                                                ProjectInstructorDAO(); List<String> projectIDList =
                                                proinsDao.getAllProjectByInstructorID("1");
