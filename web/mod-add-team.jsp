        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="content-detail content-post add-post">
                    <h2>Thêm Nhóm Đồ Án</h2>

                    <form action="MainController" method="POST">
                        <c:if test="${requestScope.PROJECT_LIST == null}">
                            <c:redirect url="MainController?action=GetListProject&page=add-team"></c:redirect>
                        </c:if>
                        <select name="team-id" id="" required>
                            <option disabled selected>Lựa Chọn Đồ Án Cho Nhóm</option>
                        ...
                        <div class="add-project-submit">
                            <button type="submit" name="action" value="AddTeam">Lưu</button>
