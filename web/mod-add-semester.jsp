            ...
            <div id="content">
                ...
                <div class="content-detail content-post add-post">
                    ...
                    <form action="MainController" method="POST">
                        <label for="">Mã Kỳ Học</label><br>
                        <input type="text" name="semester-id" required>
                        <label for="">Tên Kỳ Học</label><br>
                        <input type="text" name="semester-name" required>

                        <div class="add-project-submit">
                            <button type="submit" name="action" value="AddSemester">Lưu</button>
