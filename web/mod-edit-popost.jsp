        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="content-detail content-post add-post">
                    <h2>Chỉnh sửa bài viết của sinh viên</h2>
                    <form action="MainController" method="POST">
                        <label for="">Sửa Tiêu Đề Bài Đăng</label><br>
                        <input type="text" name="po-post-title" value="${requestScope.POST_DETAIL.postTitle}" >
                        ...
                        <div class="project-add-upload__image post-upload__image">
                            ...
                            <input value="${requestScope.POST_DETAIL.postImage}" type="hidden" id="mod-post__preview-input" name="po-post-thumbnail">
                        ...
                        <input id="post-content" type="hidden" name="po-post-content" value="${requestScope.POST_DETAIL.postContent}">
                        <div class="add-project-submit add-post-submit">
                            <button type="submit" name="action" value="SubmitEditedPoPost">Cập Nhật</button>
                            <button class="cancel-add-btn" type="button">Hủy Bỏ</button>
                        </div> 
                        <input name="po-post-id" value="${requestScope.POST_DETAIL.postID}" type="hidden">
                        <input type="hidden" name="po-post-author" value="${requestScope.POST_DETAIL.postAuthor}">
                        <input type="hidden" name="po-post-project" value="${requestScope.POST_DETAIL.projectID}">                         
                        <input type="hidden" name="is-main-post" value="${requestScope.POST_DETAIL.isMainPost}">
                    </form>
                </div>
            </div>
        </div>
