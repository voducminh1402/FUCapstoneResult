 ...
 * @author PhongVu
 */
public class RemoveTeamController extends HttpServlet {

    private static final String ERROR = "mod-team.jsp";
    private static final String SUCCESS = "mod-team.jsp";
        ...
        try {
            ...
            if (userLogin != null) {
                for (ProjectDTO projectDTO : listPro) {
                    if (teamID.equals(projectDTO.getProjectID()) == false) {
